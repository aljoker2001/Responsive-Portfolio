        ...
        <div className="flip-card col-md-4 col-sm-6 col-12 my-2">
            <div className="flip-card-inner">
                ...
                <div className="flip-card-back p-3">
                    ...
                    {props.link !== '#' ? <a href={props.link} target='_blank'><img className='github' src='https://cdn0.iconfinder.com/data/icons/marketing-92/512/Project_management-512.png' style={{ width: 60 + 'px' }} /></a> : null}
